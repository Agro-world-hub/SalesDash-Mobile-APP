  ...
  return (
    ...
    >
      <ScrollView
        ...
        keyboardShouldPersistTaps="handled"
      >
        <View className={`flex-1 px-3 ${isDarkMode ? "bg-gray-900" : "bg-white"}`}>
          {/* Header */}
          <View className={`${isDarkMode ? "bg-gray-800" : "bg-white"} flex-row items-center h-17 shadow-lg px-1 mb-8`}>
            <BackButton navigation={navigation} />
            <Text
              style={{ fontSize: 18 }}
              className={`font-bold text-center flex-grow mr-9 text-xl ${
          ...
          >
            ...
            <View className="flex items-center justify-center w-50 h-40 mb-3 pt-18 mx-12">
              <Image
                ...
                className="w-29 h-29"
                resizeMode="contain"
               // style={{ tintColor: isDarkMode ? "#E0E0E0" : undefined }}
              />
            </View>
